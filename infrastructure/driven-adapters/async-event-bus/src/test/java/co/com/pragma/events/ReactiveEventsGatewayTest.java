...
class ReactiveEventsGatewayTest {
    ...
    void testEmitConstructsDomainEvent() {
        ...
        void testNotifyLogsEvent() {
            ...
            reactiveEventsGateway.notify(event).block();
        ...
        @Test
        void testNotifyConstructsDomainEvent() {
            Object event = new Object() {
                @Override
                public String toString() {
                    return "testNotificationEvent";
            ...
            DomainEvent capturedEvent = eventCaptor.getValue();
            assertEquals(ReactiveEventsGateway.SOME_NOTIFICATION_NAME, capturedEvent.getName());
            assertEquals(event.toString(), capturedEvent.getData().toString());
        }
